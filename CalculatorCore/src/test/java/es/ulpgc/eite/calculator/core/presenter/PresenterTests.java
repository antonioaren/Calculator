...
public class PresenterTests {
	...
	public void setUp() throws Exception {
		...
		set_presenter   (new CalculatorPresenter(_viewMock, model));
	}
	...
	public void test01_display() {
		...
		verify (get_viewMock(), times (10)).display(anyString());
	...
	public void test02_clear() {
		...
		verify (get_viewMock(), times (3)).display(anyString());
		get_inOrderMock().verify (_viewMock).display("1");
		get_inOrderMock().verify (_viewMock).display("12");
	...
	public void test03_basicOpAdd02() {
		...
		verify (get_viewMock(), times (6)).display(anyString());
	...
	public void test07_basicOp01() {
		...
		verify (get_viewMock(), times (5)).display("0");
	...
	public void test08_backspace() {
		...
		get_presenter().backspacePressed();
		verify (get_viewMock(), times (1)).display("0");
